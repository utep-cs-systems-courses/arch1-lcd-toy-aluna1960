...
void drawChar9x7(u_char col, u_char row, char c, u_int,u_int fgColorBGR, u_int bgColorBGR);

//void drawChar11x16(char rcol, char rrow, char c, u_int fgColorBGR, u_int bgColorBGR);

void drawhouse(u_int row);
